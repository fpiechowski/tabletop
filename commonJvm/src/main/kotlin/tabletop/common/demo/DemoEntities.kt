...
val demoGmUser = User(
    "Demo GM User",
    id = UUID.fromString("eb946023-ba3f-48c2-90e3-f778aab1079d")
)
...
val demoPlayerUser = User(
    "Demo Player User",
    id = UUID.fromString("d01cae9b-c89f-46fa-9492-fad1af1ead82")
)
...
val demoScene = Scene(
    ...
    id = UUID.fromString("815a027a-dfa7-44f2-83aa-a8073bd5b5bb")
)
...
val demoNonPlayerCharacter = NonPlayerCharacter(
    ...
    UUID.fromString("9186fb5e-9387-4527-a02c-15f5dabd3932")
)
...
val demoGame = DnD5eGame(
    ...
    id = UUID.fromString("543efd85-98c2-482d-a292-6c9b2c188b7a"),
...
val demoGame2 = DnD5eGame(
    ...
    gameMaster = GameMaster("gm", demoGmUser),
    players = setOf(Player("player", demoPlayerUser)),
    id = UUID.fromString("8b6c9a25-066d-4233-8f26-0cb4c141b7af")
)
